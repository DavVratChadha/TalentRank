...
# util.xlsx_to_csv("Business Intelligence Analyst Role (Req 5) - Screening Questions Responses Final.xlsx", "screening_questions_5.csv")

util.xlsx_to_csv("Business Intelligence Analyst Role (Requisition 3) - Candidate Details (RR Final).xlsx", "candidate_details_3.csv")
util.xlsx_to_csv("Business Intelligence Analyst Role (Requisition 3) - Education history.xlsx", "education_details_3.csv")
util.xlsx_to_csv("Business Intelligence Analyst Role (Requisition 4) - Candidate Details (RR Final).xlsx", "candidate_details_4.csv")
util.xlsx_to_csv("Business Intelligence Analyst Role (Requisition 4) - Education history.xlsx", "education_details_4.csv")
util.xlsx_to_csv("Business Intelligence Analyst Role (Requisition 5) - Candidate Details (RR Final).xlsx", "candidate_details_5.csv")
util.xlsx_to_csv("Business Intelligence Analyst Role (Requisition 5) - Education history.xlsx", "education_details_5.csv")

# load csv as dataframe
# screening_questions_df = util.load_csv_as_df("screening_questions_5.csv")
